...
/**
 * redis工具类
 *另外的https://blog.csdn.net/q514004204/article/details/81773686
 *
...
public class RedisUtil {
    ...
    private RedisTemplate redisTemplate;//此util已经是个bean,此属性也已自动初始化为bean
  ...
  /*  private  RedisTemplate<String, Object> redisTemplate = RedisContextUtil.getBean("redisTemplate", RedisTemplate.class);

    private  StringRedisTemplate stringRedisTemplate = RedisContextUtil.getBean("stringRedisTemplate", StringRedisTemplate.class);*/
  ...
  /*  private RedisUtil() {
    ...
    public  String getString(String key) {
        ...
        try {
            ...
            if (StringUtil.contains (e.getMessage (), "WRONGTYPE Operation against a key holding the wrong kind of value")) {
                String s ="报这个错误说明了你用的jedis方法与redis服务器中存储数据的类型存在冲突";
                LOG.error ("{}",s);
            }
            LOG.error(e.getMessage(), e);
        }
